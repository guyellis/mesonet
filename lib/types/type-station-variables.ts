/*
From this page is a finite list of station variables:
https://developers.synopticdata.com/about/station-variables/

To generate the array, copy/paste that page into a spreadsheet and use a formula in column D to generate the 3-element arrays: ="['"&A1&"', '"&B1&"', '"&C1&"'],"
*/

// The stationVariables array holds arrays of 3 elements each which represent:
// (1) Variable String (2) Name (3) Default Unit
const stationVariables = [
  ...
  ['NO2y_concentration', 'NOy-Computed Nitrogen Dioxide Concentration', 'ppb'],
  ['NO2_concentration', 'NOx-Computed Nitrogen Dioxide Concentration', 'ppb'],
  ['NH3_concentration', 'Ammonia Concentration', 'ppb'],
  ['CO_concentration', 'Carbon Monoxide Concentration', 'ppm'],
  ...
  ['NO_concentration', 'Nitric Oxide Concentration', 'ppb'],
  ['NOx_concentration', 'Nitrogen Oxides Concentration', 'ppb'],
  ['NOy_concentration', 'Total Reactive Nitrogen Concentration', 'ppb'],
  ['PM_10_concentration', 'PM_10 Concentration', 'ug/m3'],
  ['SO2_concentration', 'Sulfur Dioxide Concentration', 'ppb'],
  ['UV_370nm_concentration', '370nm Aethelometer Channel', 'ug/m3'],
  ['precip_interval', 'Precipitation Interval', 'Millimeters'],
  ['snow_core_water_equiv', 'Snow Core Water Equivalent', 'Millimeters'],
  ['fosberg_fire_weather_index', 'Fosberg Fire Weather Index', ''],
  ['visibility_code', 'Visibility Code', ''],
  ['estimated_snowfall_rate', 'Estimated Snowfall_Rate', 'Millimeters'],
  ['surface_level', 'Surface Level', 'Millimeters'],
  ['precip_accum_since_00utc', 'Precipitation_since 00_UTC', 'Millimeters'],
  ['gage_height', 'Gauge height', 'ft'],
  ...
  ['snow_accum_24_hour', 'Snow 24hr', 'Millimeters'],
  ...
  ['cloud_layer_1', 'Cloud layer 1', ''],
  ['cloud_layer_3', 'Cloud layer 3', ''],
  ['cloud_layer_2', 'Cloud layer 2', ''],
...
const stationVariableKeys = stationVariables.map((sv) => sv[0]);

export type StationVariableKeys = typeof stationVariableKeys[number];
